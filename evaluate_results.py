...
def evaluate(samples_path, sample_rate, metrics, logger):

    output_dataset = OutputDataset(samples_path, sample_rate)
...
def loadResults(samples_path,  sample_rate, metrics):
...
if __name__ == '__main__':
    ...
    loadResults(samples_path, sample_rate, metrics)
